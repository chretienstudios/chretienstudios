...
export const SERVICES = [
  {
    top: "Creative Matchday",
    accent: "weekly graphics",
    lead: "Your matchday essentials, on brand.",
    body: "The matchday essentials without the retainer. The core set every club needs each week, delivered with a consistent club identity.",
  ...
  {
    top: "Creative Season",
    accent: "full-season support",
    lead: "A full season of matchday content.",
    body: "Flexible creative support for clubs that need reliable, professional matchday content throughout the season. Lineups, goals, HT/FT, player announcements and fixtures, delivered with a consistent club identity and quick turnaround.",
    includes: [
  ...
  {
    top: "Creative Partnership",
    accent: "year-round, whole club",
    lead: "The whole club, looked after.",
    body: "A dedicated creative partnership for clubs looking for ongoing design support across the entire season. We work alongside your club across matchday content, sponsorship and commercial assets, coaching materials, campaigns and key club communications.",
    includes: [
